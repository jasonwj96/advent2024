...
you each somehow got your own personal mini submarine. The Historians jet away in search of the Chief,
...
a three-block file, four blocks of free space, and then a five-block file. A disk map like 90909
...
free space block (until there are no gaps remaining between file blocks). For the disk map 12345,
